				...
				if(!empty($carts)){
					...
					<div class="cart__item">
						<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<path fill-rule="evenodd" clip-rule="evenodd" d="M8.13437 11.9329L5.78359 9.58214L5 10.3657L8.13437 13.5001L14.8509 6.78359L14.0673 6L8.13437 11.9329Z" fill="black" />
						</svg>

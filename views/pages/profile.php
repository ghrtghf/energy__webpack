			...
			<form action="" method="POST" class="profile__form">
				...
				<div class="profile__row">
					<div class="profile__name">
						<label>
							<p>имя</p>
							<input class="profile__input-info" type="text" name="name" value="<?= $user->name() ?>" disabled>
					...
					<div class="profile__phone">
						<label>
							<p>телефон</p>
							<input class="profile__input-info" type="text" name="phone" value="<?= $user->phone() ?>" disabled>
							<?php if($session->has('phone')){ ?>
								<?php echo $session->getFlash('phone')[0] ?>
							<?php } ?>
						</label>
					</div>
				</div>
				<div class="profile__row">
					<div class="profile__email">
						<label>
							<p>почта</p>
							<input class="profile__input-info" type="text" name="email" value="<?= $user->email() ?>" disabled>
